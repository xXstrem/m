...
send(msg_chat_id,msg_id, '• تم تعطيل امر الزخرفة مسبقا\n ✓',"md")
else
Redis:set(Fast.."zhrfa"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '• تم تعطيل امر الزخرفة\n ✓',"md")
end
end
if text == "تفعيل الزخرفة" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
send(msg_chat_id,msg_id, '• تم تفعيل امر الزخرفة مسبقا\n ✓',"md")
else
Redis:del(Fast.."zhrfa"..msg.chat_id)
send(msg_chat_id,msg_id, '• تم تفعيل امر الزخرفة\n ✓',"md")
end
end
if text == "زخرفة" then
if Redis:get(Fast.."zhrfa"..msg.chat_id) then
return send(msg.chat_id,msg.id,"• الزخرفة معطلة")
end
...
return send(msg_chat_id,msg_id, "مرحبا بك في الزخرفة","md",false,false,false,false,reply_markup)
end
-- z eng
